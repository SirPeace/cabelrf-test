<x-app-layout>
  <div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      @if (session('user.create_status') === 'success')
      ...
      @if (session('user.delete_status') === 'success')
        <div class="bg-green-50 bg-opacity-50 text-green-700 p-4 mb-4 rounded border border-green-600">
          <p>{{ __('The user was successfully deleted!') }}</p>
        </div>
      @endif

      @if (session('user.multiple_delete_status') === 'success')
        <div class="bg-green-50 bg-opacity-50 text-green-700 p-4 mb-4 rounded border border-green-600">
          <p>{{ __('Selected users were successfully deleted!') }}</p>
        </div>
      @endif
            ...
            <div class="flex items-center">
              <div class="space-x-1">
                <button x-show="selected > 0"
                        ...
                        @click="document.forms['users.destroy-multiple'].submit()">
