            ...
            @forelse ($products as $product)
              <tr class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    <div class="flex-shrink-0 w-14">
                      <img class="rounded-full" src="{{ $product->thumbnail_url }}"
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-3">
                  ...
                  <a class="text-red-600 hover:text-red-900" title="{{ __('Delete') }}" onclick='
                        if (confirm(" {{ __("Delete product #{$product->id}") }} "))
                    window.location="{{ route('products.destroy', ['product' => $product]) }}"'>
                    <svg class="inline h-5 w-5 relative right-2" viewBox="0 0 20 20" fill="currentColor">
