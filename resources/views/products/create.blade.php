      ...
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
          ...
          <form action="{{ route('products.store') }}"
            ...
            <div class="flex-grow">
              <div>
                <x-label for="product_title" :value="__('Title')" required />
              ...
              <div class="mt-4">
                <x-label for="product_slug" :value="__('Slug') . ' (generates from title by default)'" />
              ...
              <div class="mt-4">
                <x-label for="product_status_id" :value="__('Status')" required />
              ...
              <div class="mt-4">
                <x-label for="product_available_count" :value="__('Available count')" required />
              ...
              <x-button type="submit" class="mt-4">Add product</x-button>
            </div>
